...
import 'package:shareindia_health_camp/core/error/exceptions.dart';
...
class RemoteDataSourceImpl implements RemoteDataSource {
  ...
  Future get({
    ...
    try {
      var response = await dio.get(apiUrl, queryParameters: requestParams);
  ...
  Future post({
    ...
    try {
      var response = await dio.post(
        ...
        data:
            postAsFormData
                ? FormData.fromMap(requestParams)
  ...
  Future getWithCustomBaseUrl({
    ...
    try {
      var response = await dio2.get(apiUrl, queryParameters: requestParams);
      return response.data;
    } on DioException catch (e) {
      printLog(e.toString());
      rethrow;
